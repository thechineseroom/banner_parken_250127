...
if (reversed == null) { reversed = false; }
	...
	this.clickArea.setTransform(-1173.6,1873.7,1.9375,4.32,0,0,0,255.3,125);
...
p.nominalBounds = new cjs.Rectangle(-708.2,540,2593.9,1873.6999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/logo_largebuc.png?1739355301993", id:"logo_largebuc"}
	],
	preloads: []
};

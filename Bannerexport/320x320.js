...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("Ta steget och gör \nskillnad – på riktigt. ", "24px 'CircularXX'", "#FFFFFF");
...
}).prototype = getMCSymbolPrototype(lib.Text4MC, new cjs.Rectangle(0,0,348.1,96.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text4test = new cjs.Text("15 000 kvadratmeter \nsimulerad \nbyggarbetsplats.", "24px 'CircularXX'", "#FFFFFF");
	this.text4test.name = "text4test";
	this.text4test.lineHeight = 32;
...
}).prototype = getMCSymbolPrototype(lib.Text3MC, new cjs.Rectangle(0,0,348.1,96.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text2test = new cjs.Text("Upplevelsebaserade \nutbildningar för en sund \noch säker arbetsmiljö.", "24px 'CircularXX'", "#FFFFFF");
	this.text2test.name = "text2test";
	this.text2test.lineHeight = 32;
...
}).prototype = getMCSymbolPrototype(lib.Text2MC, new cjs.Rectangle(0,0,348.1,118.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text1test = new cjs.Text("Gör skillnad.", "bold 46px 'CircularXX'", "#26A7FF");
	this.text1test.name = "text1test";
	this.text1test.lineHeight = 59;
...
// stage content:
(lib._320x320 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(157.05,283,1,1,0,0,0,90,30);

	this.text4 = new lib.Text4MC();
	this.text4.name = "text4";
	this.text4.setTransform(193.05,143.1,1,1,0,0,0,174,30.1);

	this.text3 = new lib.Text3MC();
	this.text3.name = "text3";
	this.text3.setTransform(193.05,143.1,1,1,0,0,0,174,30.1);

	this.text2 = new lib.Text2MC();
	this.text2.name = "text2";
	this.text2.setTransform(193.05,143.1,1,1,0,0,0,174,30.1);

	this.text1 = new lib.TestSymbol1();
	this.text1.name = "text1";
	this.text1.setTransform(113.05,93,1,1,0,0,0,52,8);

	this.instance_1 = new lib.BlubackgroundMC();
	this.instance_1.setTransform(160.5,160.5,0.7772,1.3375,0,0,0,206.5,120);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.text1},{t:this.text2},{t:this.text3},{t:this.text4},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(160,160,207.10000000000002,161);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/parken_logo.png?1737985590273", id:"parken_logo"}
	],
	preloads: []
};
